...
public class Salary {
	...
	private int conveyenceAllowance, otherAllowance, personalAllowance, monthlyTax, epf, companyPf, gratuity, grossSalary, netSalary;
	public Salary(int basicSalary, int hra, int conveyenceAllowance,
			...
			int companyPf, int gratuity, int grossSalary) {
		super();
	...
	public Salary(int basicSalary) {
		...
		otherAllowance = 20*basicSalary/100;
		personalAllowance = 25*basicSalary/100;
		grossSalary = basicSalary + hra + otherAllowance + personalAllowance;
	}
