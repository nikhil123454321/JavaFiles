...
public class MainClass {
	public static void main(String[] args) {
		...
		try {
			int associateId = payrollServices.acceptAssociateDetails("Nikhil", "Maheshwari", "nikhil@gmail.com", "NFS", "Sr.Con", "nh123fd", 12000, 20000, 1000, 1000, 1212354, "hdfc", "hdfc00025");
